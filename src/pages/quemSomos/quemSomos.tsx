        ...
        <div className={styles.home}>
            ...
            <div className={styles.text}>
                ...
                <h4>Movidos por tecnologia: Sempre com um olhar para o futuro!<br /><br />
                    ...
                    <p>
                        <h4>A partir do TopSapp a Multiware Tecnologia cresceu rapidamente e surgem outras marcas como TwSpeed Telecom, A Folha Notícias, 
                        TopDNS e TopCabo. Em 2019 um novo capítulo na história passa a ser escrito, surge o Grupo Ad Brax.</h4>
                    </p>
                    <p>
                        <h4>
                    ...
                    <p>
                        <h4>O grupo Ad Brax é um sonho que se tornou realidade.</h4>
                    </p>
                </h4>
